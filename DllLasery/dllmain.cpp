...
extern "C" {
			...
			double d1, double d2, double d3, double d4, double d5, double d6, double d7, double d8)
	{
		...
		//	material_C = 1, // ktory material C, gdzies nizej jest legend
		//	nz = 1500,      //liczba pkt do dyskretyzacji. z testow zbieznosci wychodiz, ze 1500 jest spoko
		//	liczba = 7,     //liczba wartosci wlasnych/funkcji wlasnych liczonych przez Martina Deana
		...
		//	T = 300,     //Temperatura 
		//	x = 0.15,    //sklad x materialu B
		//	y = 0.75,   //no reszta analogicznie
		//	x2 = 0.65,     //tylko tutaj dla C
		//	y2 = 0.999999;
	...
	//to co leci do pliku "wyniki" leci na wykres
		...
		plik2 << pot2[material_C][6];  //grubosc kryczyna 2
		return 0;
...
void  martinDin(double* v, double* m, int number, double** envelope_functions, double* energies, double delta_z, int nz)
{
	...
	double x=0, x0, x1, xk, dx, xroot, xw, y1, y2, dok, w1, w2, delta, xmx, xmy, g0, energia, calka;
	double potmin, potmax, max_psi;
	//double del_m[nz], del_p[nz], psi_dwsz[nz], pr[nz];
